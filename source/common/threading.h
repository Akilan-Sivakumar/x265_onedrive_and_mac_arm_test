...
#define ATOMIC_AND(ptr, mask) __atomic_and_fetch(ptr, mask, __ATOMIC_SEQ_CST)
#define ATOMIC_INC(ptr)       __atomic_fetch_add(reinterpret_cast<volatile int32_t*>(ptr), 1, __ATOMIC_SEQ_CST)
#define ATOMIC_DEC(ptr)       __atomic_fetch_sub(reinterpret_cast<volatile int32_t*>(ptr), 1, __ATOMIC_SEQ_CST)
